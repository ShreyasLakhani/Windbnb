...
const SearchInputField = ({ onClose, searchQuery }) => {
  ...
  return (
    <div className="fixed z-50 overflow-y-scroll h-full lg:h-auto w-full top-0 left-0 p-4 bg-white lg:flex lg:flex-row lg:items-start lg:justify-between lg:pr-[4rem] lg:py-[4rem] xl:pr-[6.06rem]">
      ...
      <div className="flex flex-col lg:flex-row w-[90%] justify-between lg:justify-end lg:space-x-8 px-[1.62rem] py-[0.69rem] lg:py-0 space-y-6 lg:space-y-0">
        <div>
          <div className="flex flex-col lg:w-[20.625rem] group lg:px-[1.69rem] lg:py-[0.63rem] lg:rounded-[1rem] lg:border-[2px] lg:shadow-md p-2 transition duration-300 ease-in-out lg:hover:border-gray-500 xl:w-[26.625rem]">
